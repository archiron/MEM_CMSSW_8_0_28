...
#ifndef CPPProcess_DY_ddbar_to_ssbar_cc
#define CPPProcess_DY_ddbar_to_ssbar_cc

#include "MEM/MEMAlgo/interface/CPPProcess_DY_ddbar_to_ssbar.h"
...
// Process: d d~ > s s~ ta- ta+ WEIGHTED=6

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_DY_ddbar_to_ssbar::initProc(string param_card_name) 
{
...
void CPPProcess_DY_ddbar_to_ssbar::sigmaKin() 
{
...
double CPPProcess_DY_ddbar_to_ssbar::sigmaHat() 
{
...
void CPPProcess_DY_ddbar_to_ssbar::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_DY_ddbar_to_ssbar::matrix_ddx_ssxtamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
