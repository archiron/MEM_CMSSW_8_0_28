...
#ifndef CPPProcess_DY_dd_to_dd_cc
#define CPPProcess_DY_dd_to_dd_cc


#include "MEM/MEMAlgo/interface/CPPProcess_DY_dd_to_dd.h"
...
void CPPProcess_DY_dd_to_dd::initProc(string param_card_name) 
{
...
void CPPProcess_DY_dd_to_dd::sigmaKin() 
{
...
double CPPProcess_DY_dd_to_dd::sigmaHat() 
{
...
void CPPProcess_DY_dd_to_dd::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[2], w[11], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1P0_3(w[1], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  ...
  FFV2_3_2(w[0], w[10], pars->GC_50, pars->GC_58, pars->ZERO, pars->ZERO,
      w[17]);
  FFV1P0_3(w[1], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  ...
  FFV1_0(w[12], w[2], w[7], pars->GC_1, amp[4]); 
  FFV1_0(w[1], w[13], w[7], pars->GC_1, amp[5]); 
  FFV2_3_0(w[12], w[2], w[10], pars->GC_50, pars->GC_58, amp[6]); 
  FFV2_3_0(w[1], w[13], w[10], pars->GC_50, pars->GC_58, amp[7]); 
  FFV1_0(w[15], w[3], w[7], pars->GC_1, amp[8]); 
  FFV1_0(w[16], w[3], w[14], pars->GC_11, amp[9]); 
  FFV2_3_0(w[15], w[3], w[10], pars->GC_50, pars->GC_58, amp[10]); 
  FFV1_0(w[17], w[3], w[14], pars->GC_11, amp[11]); 
  FFV1_0(w[19], w[2], w[7], pars->GC_1, amp[12]); 
  FFV1_0(w[16], w[2], w[18], pars->GC_11, amp[13]); 
  FFV2_3_0(w[19], w[2], w[10], pars->GC_50, pars->GC_58, amp[14]); 
  FFV1_0(w[17], w[2], w[18], pars->GC_11, amp[15]); 

}
double CPPProcess_DY_dd_to_dd::matrix_dd_ddtamtap() 
{
  int i, j; 
  // Local variables
