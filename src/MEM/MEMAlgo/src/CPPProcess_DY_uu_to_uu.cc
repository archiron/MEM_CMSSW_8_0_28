...
#ifndef CPPProcess_DY_uu_to_uu_cc
#define CPPProcess_DY_uu_to_uu_cc


#include "MEM/MEMAlgo/interface/CPPProcess_DY_uu_to_uu.h"
...
void CPPProcess_DY_uu_to_uu::initProc(string param_card_name) 
{
...
void CPPProcess_DY_uu_to_uu::sigmaKin() 
{
...
double CPPProcess_DY_uu_to_uu::sigmaHat() 
{
...
void CPPProcess_DY_uu_to_uu::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_0(w[8], w[3], w[7], pars->GC_2, amp[0]); 
  FFV1_0(w[1], w[9], w[7], pars->GC_2, amp[1]); 
  FFV2_5_0(w[8], w[3], w[10], pars->GC_51, pars->GC_58, amp[2]); 
  ...
  FFV1_0(w[15], w[3], w[7], pars->GC_2, amp[8]); 
  FFV1_0(w[16], w[3], w[14], pars->GC_11, amp[9]); 
  FFV2_5_0(w[15], w[3], w[10], pars->GC_51, pars->GC_58, amp[10]); 
  FFV1_0(w[17], w[3], w[14], pars->GC_11, amp[11]); 
  FFV1_0(w[19], w[2], w[7], pars->GC_2, amp[12]); 
  FFV1_0(w[16], w[2], w[18], pars->GC_11, amp[13]); 
  FFV2_5_0(w[19], w[2], w[10], pars->GC_51, pars->GC_58, amp[14]); 
  FFV1_0(w[17], w[2], w[18], pars->GC_11, amp[15]); 

}
double CPPProcess_DY_uu_to_uu::matrix_uu_uutamtap() 
{
  int i, j; 
  // Local variables
