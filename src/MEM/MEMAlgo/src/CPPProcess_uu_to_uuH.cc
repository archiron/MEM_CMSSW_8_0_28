...
#ifndef CPPProcess_uu_to_uuH_cc
#define CPPProcess_uu_to_uuH_cc

#include "MEM/MEMAlgo/interface/CPPProcess_uu_to_uuH.h"
...
void CPPProcess_uu_to_uuH::initProc(string param_card_name) 
{
...
void CPPProcess_uu_to_uuH::sigmaKin() 
{
...
double CPPProcess_uu_to_uuH::sigmaHat() 
{
...
void CPPProcess_uu_to_uuH::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_uu_to_uuH::matrix_uu_uuh_h_tamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 2; 
