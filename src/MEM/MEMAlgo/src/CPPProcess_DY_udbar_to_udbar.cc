...
#ifndef CPPProcess_DY_udbar_to_udbar_cc
#define CPPProcess_DY_udbar_to_udbar_cc

#include "MEM/MEMAlgo/interface/CPPProcess_DY_udbar_to_udbar.h"
...
void CPPProcess_DY_udbar_to_udbar::initProc(string param_card_name) 
{
...
void CPPProcess_DY_udbar_to_udbar::sigmaKin() 
{
...
double CPPProcess_DY_udbar_to_udbar::sigmaHat() 
{
...
void CPPProcess_DY_udbar_to_udbar::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_DY_udbar_to_udbar::matrix_udx_udxtamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
