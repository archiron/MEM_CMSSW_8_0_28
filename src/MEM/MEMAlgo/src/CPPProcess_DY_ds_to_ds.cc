...
#ifndef CPPProcess_DY_ds_to_ds_cc
#define CPPProcess_DY_ds_to_ds_cc

#include "MEM/MEMAlgo/interface/CPPProcess_DY_ds_to_ds.h"
...
void CPPProcess_DY_ds_to_ds::initProc(string param_card_name) 
{
...
void CPPProcess_DY_ds_to_ds::sigmaKin() 
{
...
double CPPProcess_DY_ds_to_ds::sigmaHat() 
{
...
void CPPProcess_DY_ds_to_ds::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_DY_ds_to_ds::matrix_ds_dstamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
