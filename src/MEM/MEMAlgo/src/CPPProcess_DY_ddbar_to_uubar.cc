...
#ifndef CPPProcess_DY_ddbar_to_uubar_cc
#define CPPProcess_DY_ddbar_to_uubar_cc


#include "MEM/MEMAlgo/interface/CPPProcess_DY_ddbar_to_uubar.h"
...
// Process: d d~ > u u~ ta- ta+ WEIGHTED=6

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_DY_ddbar_to_uubar::initProc(string param_card_name) 
{
...
void CPPProcess_DY_ddbar_to_uubar::sigmaKin() 
{
...
double CPPProcess_DY_ddbar_to_uubar::sigmaHat() 
{
...
void CPPProcess_DY_ddbar_to_uubar::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_0(w[12], w[1], w[7], pars->GC_1, amp[4]); 
...
double CPPProcess_DY_ddbar_to_uubar::matrix_ddx_uuxtamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
