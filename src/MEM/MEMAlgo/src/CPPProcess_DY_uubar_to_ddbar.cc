...
#ifndef CPPProcess_DY_uubar_to_ddbar_cc
#define CPPProcess_DY_uubar_to_ddbar_cc

#include "MEM/MEMAlgo/interface/CPPProcess_DY_uubar_to_ddbar.h"
...
// Process: u u~ > d d~ ta- ta+ WEIGHTED=6

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_DY_uubar_to_ddbar::initProc(string param_card_name) 
{
...
void CPPProcess_DY_uubar_to_ddbar::sigmaKin() 
{
...
double CPPProcess_DY_uubar_to_ddbar::sigmaHat() 
{
...
void CPPProcess_DY_uubar_to_ddbar::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_DY_uubar_to_ddbar::matrix_uux_ddxtamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
