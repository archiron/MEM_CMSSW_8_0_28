...
#ifndef CPPProcess_gg_to_ttbar_cc
#define CPPProcess_gg_to_ttbar_cc
...
void CPPProcess_gg_to_ttbar::initProc(string param_card_name) 
{
...
void CPPProcess_gg_to_ttbar::sigmaKin() 
{
...
double CPPProcess_gg_to_ttbar::sigmaHat() 
{
...
void CPPProcess_gg_to_ttbar::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_gg_to_ttbar::matrix_gg_ttx() 
{
  int i, j; 
  // Local variables
//  const int ngraphs = 3; 
