...
#ifndef CPPProcess_DY_dsbar_to_dsbar_cc
#define CPPProcess_DY_dsbar_to_dsbar_cc


#include "MEM/MEMAlgo/interface/CPPProcess_DY_dsbar_to_dsbar.h"
...
void CPPProcess_DY_dsbar_to_dsbar::initProc(string param_card_name) 
{
...
void CPPProcess_DY_dsbar_to_dsbar::sigmaKin() 
{
...
double CPPProcess_DY_dsbar_to_dsbar::sigmaHat() 
{
...
void CPPProcess_DY_dsbar_to_dsbar::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_DY_dsbar_to_dsbar::matrix_dsx_dsxtamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
