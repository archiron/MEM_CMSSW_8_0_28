...
#ifndef CPPProcess_ttZ_Zonly_gg_cc
#define CPPProcess_ttZ_Zonly_gg_cc
...
void CPPProcess_ttZ_Zonly_gg::initProc(string param_card_name) 
{
...
void CPPProcess_ttZ_Zonly_gg::sigmaKin() 
{
...
double CPPProcess_ttZ_Zonly_gg::sigmaHat() 
{
...
void CPPProcess_ttZ_Zonly_gg::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_ttZ_Zonly_gg::matrix_gg_ttxz_z_tamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
