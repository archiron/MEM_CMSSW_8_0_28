...
#ifndef CPPProcess_ttH_qqbar_cc
#define CPPProcess_ttH_qqbar_cc
...
void CPPProcess_ttH_qqbar::initProc(string param_card_name) 
{
...
void CPPProcess_ttH_qqbar::sigmaKin() 
{
...
double CPPProcess_ttH_qqbar::sigmaHat() 
{
...
void CPPProcess_ttH_qqbar::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_ttH_qqbar::matrix_uux_ttxh_h_tamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 2; 
