...
#ifndef CPPProcess_ttH_gg_cc
#define CPPProcess_ttH_gg_cc
...
void CPPProcess_ttH_gg::initProc(string param_card_name) 
{
...
void CPPProcess_ttH_gg::sigmaKin() 
{
...
double CPPProcess_ttH_gg::sigmaHat() 
{
...
void CPPProcess_ttH_gg::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_ttH_gg::matrix_gg_ttxh_h_tamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
