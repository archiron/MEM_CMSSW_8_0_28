...
#ifndef CPPProcess_DY_uubar_to_ccbar_cc
#define CPPProcess_DY_uubar_to_ccbar_cc


#include "MEM/MEMAlgo/interface/CPPProcess_DY_uubar_to_ccbar.h"
...
// Process: u u~ > c c~ ta- ta+ WEIGHTED=6

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_DY_uubar_to_ccbar::initProc(string param_card_name) 
{
...
void CPPProcess_DY_uubar_to_ccbar::sigmaKin() 
{
...
double CPPProcess_DY_uubar_to_ccbar::sigmaHat() 
{
...
void CPPProcess_DY_uubar_to_ccbar::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_4_3(w[5], w[4], pars->GC_50, pars->GC_59, pars->mdl_MZ, pars->mdl_WZ,
      w[10]);
  FFV1P0_3(w[3], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  ...
  FFV1_0(w[12], w[1], w[7], pars->GC_2, amp[4]); 
  FFV1_0(w[13], w[1], w[11], pars->GC_11, amp[5]); 
  FFV2_5_0(w[12], w[1], w[10], pars->GC_51, pars->GC_58, amp[6]); 
  FFV1_0(w[14], w[1], w[11], pars->GC_11, amp[7]); 

}
double CPPProcess_DY_uubar_to_ccbar::matrix_uux_ccxtamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
