...
#ifndef CPPProcess_DY_gg_to_uubar_cc
#define CPPProcess_DY_gg_to_uubar_cc

#include "MEM/MEMAlgo/interface/CPPProcess_DY_gg_to_uubar.h"
...
// Process: g g > u u~ ta- ta+ WEIGHTED=6
// Process: g g > c c~ ta- ta+ WEIGHTED=6

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_DY_gg_to_uubar::initProc(string param_card_name) 
{
...
void CPPProcess_DY_gg_to_uubar::sigmaKin() 
{
...
double CPPProcess_DY_gg_to_uubar::sigmaHat() 
{
...
void CPPProcess_DY_gg_to_uubar::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_DY_gg_to_uubar::matrix_gg_uuxtamtap() 
{
  int i, j; 
  // Local variables
