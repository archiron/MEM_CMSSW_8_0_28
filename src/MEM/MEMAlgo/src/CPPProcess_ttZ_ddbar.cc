...
#ifndef CPPProcess_ttZ_ddbar_cc
#define CPPProcess_ttZ_ddbar_cc
...
// Process: d d~ > t t~ ta- ta+ WEIGHTED=6 / h
// Process: s s~ > t t~ ta- ta+ WEIGHTED=6 / h

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_ttZ_ddbar::initProc(string param_card_name) 
{
...
void CPPProcess_ttZ_ddbar::sigmaKin() 
{
...
double CPPProcess_ttZ_ddbar::sigmaHat() 
{
...
void CPPProcess_ttZ_ddbar::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_ttZ_ddbar::matrix_ddx_ttxtamtap_no_h() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
