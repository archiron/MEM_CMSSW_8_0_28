...
#ifndef CPPProcess_DY_uc_to_uc_cc
#define CPPProcess_DY_uc_to_uc_cc


#include "MEM/MEMAlgo/interface/CPPProcess_DY_uc_to_uc.h"
...
void CPPProcess_DY_uc_to_uc::initProc(string param_card_name) 
{
...
void CPPProcess_DY_uc_to_uc::sigmaKin() 
{
...
double CPPProcess_DY_uc_to_uc::sigmaHat() 
{
...
void CPPProcess_DY_uc_to_uc::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_DY_uc_to_uc::matrix_uc_uctamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
