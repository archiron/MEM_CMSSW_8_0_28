...
#ifndef CPPProcess_DY_ucbar_to_ucbar_cc
#define CPPProcess_DY_ucbar_to_ucbar_cc

#include "MEM/MEMAlgo/interface/CPPProcess_DY_ucbar_to_ucbar.h"
...
void CPPProcess_DY_ucbar_to_ucbar::initProc(string param_card_name) 
{
...
void CPPProcess_DY_ucbar_to_ucbar::sigmaKin() 
{
...
double CPPProcess_DY_ucbar_to_ucbar::sigmaHat() 
{
...
void CPPProcess_DY_ucbar_to_ucbar::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_DY_ucbar_to_ucbar::matrix_ucx_ucxtamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
