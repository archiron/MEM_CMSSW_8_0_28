...
#ifndef CPPProcess_gu_to_ttbaru_cc
#define CPPProcess_gu_to_ttbaru_cc
...
// Process: g u > t t~ u WEIGHTED=3

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_gu_to_ttbaru::initProc(string param_card_name) 
{
...
void CPPProcess_gu_to_ttbaru::sigmaKin() 
{
...
double CPPProcess_gu_to_ttbaru::sigmaHat() 
{
...
void CPPProcess_gu_to_ttbaru::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_gu_to_ttbaru::matrix_gu_ttxu() 
{
  int i, j; 
  // Local variables
//  const int ngraphs = 5; 
