...
#ifndef CPPProcess_uubar_to_ttbar_cc
#define CPPProcess_uubar_to_ttbar_cc
...
void CPPProcess_uubar_to_ttbar::initProc(string param_card_name) 
{
...
void CPPProcess_uubar_to_ttbar::sigmaKin() 
{
...
//  std::complex<double> * * wfs; 
  ...
  static const int helicities[16][4] = {{-1, -1, -1, -1}, {-1, -1,
...
double CPPProcess_uubar_to_ttbar::sigmaHat() 
{
...
void CPPProcess_uubar_to_ttbar::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_uubar_to_ttbar::matrix_uux_ttx() 
{
  int i, j; 
  // Local variables
//  const int ngraphs = 1; 
