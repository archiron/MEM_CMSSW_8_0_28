...
#ifndef CPPProcess_DY_uubar_to_gg_cc
#define CPPProcess_DY_uubar_to_gg_cc

#include "MEM/MEMAlgo/interface/CPPProcess_DY_uubar_to_gg.h"
...
// Process: u u~ > g g ta- ta+ WEIGHTED=6

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_DY_uubar_to_gg::initProc(string param_card_name) 
{
...
void CPPProcess_DY_uubar_to_gg::sigmaKin() 
{
...
double CPPProcess_DY_uubar_to_gg::sigmaHat() 
{
...
void CPPProcess_DY_uubar_to_gg::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_0(w[10], w[1], w[8], pars->GC_2, amp[2]); 
  FFV2_5_0(w[10], w[1], w[9], pars->GC_51, pars->GC_58, amp[3]); 
  FFV1_0(w[11], w[12], w[8], pars->GC_2, amp[4]); 
  FFV2_5_0(w[11], w[12], w[9], pars->GC_51, pars->GC_58, amp[5]); 
  FFV1_0(w[13], w[1], w[8], pars->GC_2, amp[6]); 
  FFV2_5_0(w[13], w[1], w[9], pars->GC_51, pars->GC_58, amp[7]); 
  ...
  FFV1_0(w[17], w[1], w[8], pars->GC_2, amp[12]); 
  FFV1_0(w[14], w[1], w[16], pars->GC_11, amp[13]); 
  FFV2_5_0(w[17], w[1], w[9], pars->GC_51, pars->GC_58, amp[14]); 
  FFV1_0(w[15], w[1], w[16], pars->GC_11, amp[15]); 

}
double CPPProcess_DY_uubar_to_gg::matrix_uux_ggtamtap() 
{
  int i, j; 
  // Local variables
