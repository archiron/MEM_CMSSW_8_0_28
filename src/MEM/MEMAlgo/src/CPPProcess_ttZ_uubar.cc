...
#ifndef CPPProcess_ttZ_uubar_cc
#define CPPProcess_ttZ_uubar_cc
...
// Process: u u~ > t t~ ta- ta+ WEIGHTED=6 / h
// Process: c c~ > t t~ ta- ta+ WEIGHTED=6 / h

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_ttZ_uubar::initProc(string param_card_name) 
{
...
void CPPProcess_ttZ_uubar::sigmaKin() 
{
...
double CPPProcess_ttZ_uubar::sigmaHat() 
{
...
void CPPProcess_ttZ_uubar::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_ttZ_uubar::matrix_uux_ttxtamtap_no_h() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8; 
