...
#ifndef MG5_Sigma_sm_dd_ddtamtap_DY_H
#define MG5_Sigma_sm_dd_ddtamtap_DY_H
...
class CPPProcess_DY_dd_to_dd
{
  public:

    // Constructor.
    CPPProcess_DY_dd_to_dd() {}
...
#endif  // MG5_Sigma_sm_dd_ddtamtap_H
