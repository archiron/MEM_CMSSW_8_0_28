...
# include "MEM/MEMAlgo/interface/gsl_complex.h"
...
Static inline gsl_complex gsl_complex_rect (double x, double y);  /* r= real+i*imag */

// GG #ifdef HAVE_INLINE
Static inline gsl_complex
