...
#ifndef MG5_Sigma_sm_uux_ttxZtamtap_H
#define MG5_Sigma_sm_uux_ttxZtamtap_H
...
class CPPProcess_ttZ_Zonly_uubar
{
  public:

    // Constructor.
    CPPProcess_ttZ_Zonly_uubar() {}
  ...
  private:
    ...
    double matrix_uux_ttxz_z_tamtap(); 
...
#endif  // MG5_Sigma_sm_uux_ttxZtamtap_H
