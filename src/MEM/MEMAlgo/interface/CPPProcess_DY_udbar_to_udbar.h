...
#ifndef MG5_Sigma_sm_udx_udxtamtap_DY_H
#define MG5_Sigma_sm_udx_udxtamtap_DY_H
...
class CPPProcess_DY_udbar_to_udbar
{
  public:

    // Constructor.
    CPPProcess_DY_udbar_to_udbar() {}
...
#endif  // MG5_Sigma_sm_udx_udxtamtap_H
