...
#ifndef MG5_Sigma_sm_uxdx_uxdxtamtap_DY_H
#define MG5_Sigma_sm_uxdx_uxdxtamtap_DY_H
...
class CPPProcess_DY_ubardbar_to_ubardbar
{
  public:

    // Constructor.
    CPPProcess_DY_ubardbar_to_ubardbar() {}
...
#endif  // MG5_Sigma_sm_uxdx_uxdxtamtap_H
