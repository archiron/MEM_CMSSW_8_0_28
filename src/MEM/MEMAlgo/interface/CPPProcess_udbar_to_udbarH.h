...
#ifndef MG5_Sigma_sm_udx_udxtamtap_H
#define MG5_Sigma_sm_udx_udxtamtap_H
...
class CPPProcess_udbar_to_udbarH
{
  public:

    // Constructor.
    CPPProcess_udbar_to_udbarH() {}
  ...
  private:
    ...
    double matrix_udx_udxh_h_tamtap(); 
