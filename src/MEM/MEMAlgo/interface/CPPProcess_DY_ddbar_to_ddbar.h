...
#ifndef MG5_Sigma_sm_ddx_ddxtamtap_DY_H
#define MG5_Sigma_sm_ddx_ddxtamtap_DY_H
...
class CPPProcess_DY_ddbar_to_ddbar
{
  public:

    // Constructor.
    CPPProcess_DY_ddbar_to_ddbar() {}
